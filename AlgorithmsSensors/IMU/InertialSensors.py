...
class InertialSensor(AlgorithmSensor):
    ...
    def detect(self):
        data = self.getData()
        self.detectData.updateData(myPosition=tuple(data['position'].values()), myRotation=tuple(data['orientation'].values()))
    ...
    def getData(self):
        ...
        #Corigindo o z
        #dict_data['position']['z_val'] = dict_data['position']['z_val']
